                    ...
                    <div id="left">
                        ...
                        <ul class="postsList">
                            <li v-for="(item, index) in this.data.post_dict_li">
                                ...
                                <div class="subject">
                                    <div class="titleWrap"><a href="#">[CBA]</a>&nbsp;&nbsp;<h2><router-link :to="{ path:'/index/article', query: {id: item.id} }">{{item.title}}</router-link></h2></div>
                                    <p>
